...
#define STRING_CONFIG_H_AUTHOR "FM for the Makertech 3D Profoge 2s Dual"      // Who made the changes.
...
#define SWITCHING_NOZZLE
  ...
  #define SWITCHING_NOZZLE_SERVO_ANGLES { 0,  100}  // Angles for E0, E1 (single servo) or lowered/raised (dual servo)
